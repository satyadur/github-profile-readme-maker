...
export default function Home() {
  ...
  const codeString = `Hi 👋 My name is Satya
=============================
...
* 🖥️  See my portfolio at [satyadur.com](https://satyadur.github.io/portfilio/)
* ✉️  You can contact me at [satyakudupudi8500@gmail.com](mailto:satyakudupudi8500@gmail.com)
      ...
      <section className="w-full flex items-center bg-light-100 dark:bg-dark-800 min-h-screen relative">
        ...
        >
          ...
          <div className="flex items-center gap-x-4">
            <a
              href="https://github.com/satyadur/github-profile-readme-maker"
              target="_blank"
              rel="noreferrer"
